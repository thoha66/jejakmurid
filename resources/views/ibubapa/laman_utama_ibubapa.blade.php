                ...
                <div class="panel profit db mbm">
                    <div class="panel-body">
                        ...
                        <h4 class="value">
                            ...
                            </span><span> {{ $students }} Org</span></h4>
                        <p class="description">
                            Bilangan Anak</p>
        ...
        <div class="row mbl">
            <div class="row">
                <div class="col-md-12 center text-center wow pulse animated" data-wow-iteration="3" data-wow-duration="0.15s" style="visibility: visible; animation-duration: 0.15s; animation-iteration-count: 3; animation-name: pulse;">
                    <img src="{{ url('assets/intro/penjaga.png') }}" class="img-fluid img-responsive" alt="Responsive image">
                </div>
            </div>
            </br></br>
        </div>
