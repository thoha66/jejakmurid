                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            {{--<form action="{!! url('taskmark/'.$task->id) !!}" method="POST" >--}}
                                <a href="{!! url('taskmark/'.$task->id) !!}" class="btn btn btn-info btn-sm"><i class="glyphicon glyphicon-info-sign"></i>  Laporan Pencapaian</a>
                                ...
                                <a href="{!! url('taskmark/'.$task->id) !!}" class="btn btn-danger"  data-method="delete" data-token="{{csrf_token()}}" data-confirm="Are you sure?"><i class="fa fa-trash-o"></i> Buang</a>
