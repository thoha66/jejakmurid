                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <div class="input-icon right">
                      ...
                      <input id="tarikh" type="date" placeholder="" class="form-control" name="tarikh_kesalahan" value="{{ $StudentOffense_one->tarikh_kesalahan }}"></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <div class="input-icon right">
                      ...
                      <input id="masa" type="time" placeholder="" class="form-control" name="masa_kesalahan" value="{{ $StudentOffense_one->masa_kesalahan }}"></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <div class="input-icon right">
                      ...
                      <textarea rows="5" id="tempat" type="text" placeholder="" class="form-control" name="tempat_kesalahan" >{{ $StudentOffense_one->tempat_kesalahan }}</textarea>
                    </div>
                  </div>
                </div>
